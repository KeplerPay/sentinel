...
sentinel_cfg = KeplerConfig.tokenize(sentinel_config_file)
sentinel_version = "1.3.0"
min_keplerd_proto_version_with_sentinel_ping = 70207
...
def get_kepler_conf():
    ...
    kepler_conf = sentinel_cfg.get('kepler_conf', kepler_conf)
